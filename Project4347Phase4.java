...
public class Project4347Phase4 {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        while (exitVal != 1) {
            ...
            System.out.println("2. Insert Game Event.");
            System.out.println("3. Edit Player Status.");
            ...
            if (n == 1) {
                try (
                    ...
                    // Execute a query
                    System.out.print("Choose a league: ");

                    System.out.print("Choose a team: ");

                    System.out.print("Would you like to insert a player or staff member? Type 'p' or 's': ");

                    System.out.print("Type a name: ");

                    System.out.print("Type a status: ");

                    System.out.print("Type years active: ");
